    ...
    <div class="offcanvas offcanvas-start sidebar" tabindex="-1" id="offcanvasSidebar">
        ...
        <div class="offcanvas-body">
            <ul class="nav nav-pills flex-column mb-auto" id="sidebarTabs">
                ...
                <li class="nav-item">
                    <a href="?page=gradeassignments" class="nav-link <?= $page == "uploadmaterial" ? 'active' : '' ?> text-dark" data-tab="upload">
                ...
                <li class="nav-item">
                    <a href="?page=settings" class="nav-link <?= $page == "uploadmaterial" ? 'active' : '' ?> text-dark" data-tab="upload">
                        <i class="fa fa-cog me-2" aria-hidden="true"></i>
                        Settings
                    </a>
                </li>
                <li class="nav-item">
                    <a href="../../action/loginAction.php" class="nav-link text-danger" data-tab="upload">
                        <i class="fa fa-cog me-2" aria-hidden="true"></i>
                        Log Out
                    </a>
                </li>
